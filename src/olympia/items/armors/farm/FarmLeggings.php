...
class FarmLeggings extends Armor implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name) {
        ...
        $this->initComponent("farm_leggings", $creative);
    ...
    public function getMaxDurability(): int {
        return Customies::getInstance()->getParameters()["items-stats"]["farm"]["armors"]["leggings"]["durability"];
    }

    public function getDefensePoints(): int
    {
        return Customies::getInstance()->getParameters()["items-stats"]["farm"]["armors"]["leggings"]["protection"];
    }
}