...
class FarmChestplate extends Armor implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name) {
        ...
        $this->initComponent("farm_chestplate", $creative);
        ...
        $this->setLore([
            "§rCe plastron en farm sont peu §epuissantes §rmais",
