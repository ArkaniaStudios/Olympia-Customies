...
class OrichalqueChestplate extends Armor implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name) {
        ...
        $this->setLore([
            "§rCe plastron en orichalque est plus §epuissant §rque le",
            "§emythril§r, néanmoins il n'est pas le plus puissant !",
        ]);
    }

    public function getMaxDurability(): int {
        return Customies::getInstance()->getParameters()["items-stats"]["orichalque"]["armors"]["chestplate"]["durability"];
    }

    public function getDefensePoints(): int
    {
        return Customies::getInstance()->getParameters()["items-stats"]["orichalque"]["armors"]["chestplate"]["protection"];
    }
}