...
class OrichalqueLeggings extends Armor implements ItemComponents {
    ...
    public function getMaxDurability(): int {
        return Customies::getInstance()->getParameters()["items-stats"]["orichalque"]["armors"]["leggings"]["durability"];
    }

    public function getDefensePoints(): int
    {
        return Customies::getInstance()->getParameters()["items-stats"]["orichalque"]["armors"]["leggings"]["protection"];
    }
}