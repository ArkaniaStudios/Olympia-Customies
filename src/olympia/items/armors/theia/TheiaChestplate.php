...
class TheiaChestplate extends Armor implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name) {
        ...
        $this->initComponent("theia_chestplate", $creative);
        ...
        $this->setLore([
            "§rCe plastron en tehia est plus §epuissant §rque le",
            "§eorichalque§r !",
        ]);
    }

    public function getMaxDurability(): int {
        return Customies::getInstance()->getParameters()["items-stats"]["theia"]["armors"]["chestplate"]["durability"];
    }

    public function getDefensePoints(): int
    {
        return Customies::getInstance()->getParameters()["items-stats"]["theia"]["armors"]["chestplate"]["protection"];
    }
}