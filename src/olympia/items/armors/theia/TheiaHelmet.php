...
class TheiaHelmet extends Armor implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name) {
        ...
        $this->initComponent("theia_helmet", $creative);
        ...
        $this->setLore([
            "§rCe casque en theia est plus §epuissant §rque le",
            "§eorichalque§r !",
        ]);
    }

    public function getMaxDurability(): int {
        return Customies::getInstance()->getParameters()["items-stats"]["theia"]["armors"]["helmet"]["durability"];
    }

    public function getDefensePoints(): int
    {
        return Customies::getInstance()->getParameters()["items-stats"]["theia"]["armors"]["helmet"]["protection"];
    }
}