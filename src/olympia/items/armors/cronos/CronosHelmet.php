...
class CronosHelmet extends Armor implements ItemComponents {
    ...
    public function getMaxDurability(): int {
        return Customies::getInstance()->getParameters()["items-stats"]["cronos"]["armors"]["helmet"]["durability"];
    }

    public function getDefensePoints(): int
    {
        return Customies::getInstance()->getParameters()["items-stats"]["cronos"]["armors"]["helmet"]["protection"];
    }
}