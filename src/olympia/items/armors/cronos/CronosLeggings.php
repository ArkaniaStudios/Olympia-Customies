...
class CronosLeggings extends Armor implements ItemComponents {
    ...
    public function getMaxDurability(): int {
        return Customies::getInstance()->getParameters()["items-stats"]["cronos"]["armors"]["leggings"]["durability"];
    }

    public function getDefensePoints(): int
    {
        return Customies::getInstance()->getParameters()["items-stats"]["cronos"]["armors"]["leggings"]["protection"];
    }
}