...
class CronosBoots extends Armor implements ItemComponents {
    ...
    public function getMaxDurability(): int {
        return Customies::getInstance()->getParameters()["items-stats"]["cronos"]["armors"]["boots"]["durability"];
    }

    public function getDefensePoints(): int
    {
        return Customies::getInstance()->getParameters()["items-stats"]["cronos"]["armors"]["boots"]["protection"];
    }
}