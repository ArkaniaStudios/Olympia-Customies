...
class NobuildStick extends Item implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name = "Unknown", array $enchantmentTags = []) {
        ...
        $this->initComponent("nobuild_stick", $creative);
        $this->setLore([
            "§rCet objet permet d'empêcher un joueur de §econstruire§r.",
        ]);
    }
}